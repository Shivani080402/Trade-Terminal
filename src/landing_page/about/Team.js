    ...
    return ( 
      ...
      <div className="row text-muted" style={{lineHeight : "1.8" , fontSize : "17px"}}>
        ...
        <div className="col-6 p-5 ">
          <p>Nithin bootstrapped and founded Trade-Terminal in 2010 to overcome the hurdles he faced during his decade long stint as a trader. Today, Trade-Terminal has changed the landscape of the Indian broking industry.</p>
